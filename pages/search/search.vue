<template>
	<view style="margin: auto; width: 95%;">
		<view class="jincehng-input-box">
			<input class="jincheng-input" type="text" @input="chone()" value="" placeholder="输入关键字" v-model="searchcontent" />
			<view class=" text-red cu-btn round lines-red jincheng-search" @click="search()">
				搜索
			</view>
		</view>
    ...
    width: 95%;">
			...
			<view class="margin" v-show="isSistory">
				...
				<view class="flex flex-wrap">
					<view class="jincehng-ti jincheng-font bg-grey round margin-lr-sm margin-top " v-for="(item,index) in historyList"
