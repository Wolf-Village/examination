	...
	<view>
		...
		<view class="news">
			...
			<view class="news-item">
				<view class="padding-xl radius shadow shadow-lg bg-white margin-top news-fu flex justify-between" v-for="item in dlist" :key="item._id" @click="opennews" :data-postid="item.post_id">
